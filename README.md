...
_________________________
## Demo
The picture below is what the scene will look like on the initial load, with clouds, a sun and a "clear sky".  The small UI control panel in the top-left corner denotes what the user is able to do in our scene.
